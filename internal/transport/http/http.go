...
func MakeInjectHealtHttpHandlers(router *mux.Router) {

}
func MakeInjectFileHttpHandlersFix(router *mux.Router) {

}

func MakeInjectConfigHttpHandlersFix(router *mux.Router) {
